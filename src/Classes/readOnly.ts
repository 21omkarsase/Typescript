class Department {
    ...
    constructor(private readonly Id: string, private name: string, public company: string, employees: { name: string, age: number }[]) {
        // this.Id = Id;
        // this.name = name;
    ...
    getDepartmentId(this: Department) {
        // this.Id = "D2";          not allowed due to readonly mode
        return this.Id;
    }
